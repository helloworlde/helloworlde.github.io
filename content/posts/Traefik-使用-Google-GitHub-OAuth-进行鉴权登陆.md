...
![在 Google Cloud 控制台创建 OAuth 客户端ID 的界面](https://img.hellowood.dev/picture/homelab-traefik-sso-google-oauth-apply-oauth-app.png)
...
![在 GitHub 开发者设置中申请 OAuth 应用并配置回调地址](https://img.hellowood.dev/picture/homelab-traefik-sso-github-oauth-apply-oauth-app.png)

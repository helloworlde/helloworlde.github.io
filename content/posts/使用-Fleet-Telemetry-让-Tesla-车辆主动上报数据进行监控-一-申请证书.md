...
![Tessie 基于特斯拉车队遥测数据的仪表盘界面](https://img.hellowood.dev/picture/homelab-tesla-fleet-telemetry-demo-tessie-dashboard.png)

![Tessie 基于 Fleet Telemetry 构建的行程列表看板界面](https://img.hellowood.dev/picture/homelab-tesla-fleet-telemetry-demo-tessie-trip-list.png)
...
![Tesla 车辆通过 Fleet Telemetry 上报数据的监控示意图](https://img.hellowood.dev/picture/homelab-tesla-fleet-telemetry-grafana-page-1.png)
...
![Tesla Fleet Telemetry 系统架构图展示各组件连接关系](https://img.hellowood.dev/picture/homelab-tesla-fleet-telemetry-diagram.drawio.svg.drawio.svg)

...
slug: "proxmox-ve-add-monitoring"
aliases:
...
![Proxmox VE 通过 InfluxDB 和 Grafana 监控指标仪表盘](https://img.hellowood.dev/picture/homelab-promoxve-monitor-metrics-dashboard.png)
...
![Proxmox VE 数据中心指标服务器添加 InfluxDB 配置界面](https://img.hellowood.dev/picture/homelab-promoxve-monitor-metrics-pve-add-influxdb.png)
...
![Grafana 添加 InfluxDB 数据源配置界面](https://img.hellowood.dev/picture/homelab-promoxve-monitor-metrics-grafana-add-datasource.png)
...
![Grafana 中导入的 Proxmox VE 监控指标仪表板](https://img.hellowood.dev/picture/homelab-promoxve-monitor-metrics-dashboard.png)

...
slug: "openwrt-install-openclash"
aliases:
...
- [OpenWrt 安装使用 Dae 作为代理](https://blog.hellowood.dev/posts/openwrt-install-dae-proxy/)
- [OpenWrt 安装使用 OpenClash 的平替软件 OpenWrt-Nikki](https://blog.hellowood.dev/posts/openwrt-openclash-alternative-nikki/)

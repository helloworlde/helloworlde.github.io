...
![VMware ESXi 8.0 离线捆绑包下载页面截图](https://img.hellowood.dev/picture/homelab-esxi-build-image-esxi8-download.png)

### 1.2 下载 NVME 社区驱动

从 [Community NVMe Driver for ESXi](https://flings.vmware.com/community-nvme-driver-for-esxi) 下载 NVME 驱动
![在 ESXi 镜像构建过程中下载 NVMe 社区驱动](https://img.hellowood.dev/picture/homelab-esxi-build-image-nvme-driver.png)
...
![下载 ESXi 社区网卡驱动以支持 Intel I225-V](https://img.hellowood.dev/picture/homelab-esxi-build-image-network-driver.png)

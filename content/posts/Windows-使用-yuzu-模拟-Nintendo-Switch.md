...
![Yuzu 模拟器下载页面显示需先安装运行库](https://img.hellowood.dev/picture/nintendo-switch-yuzu-download-page-2.png)

下载后安装

![Yuzu 模拟器安装界面显示密钥缺失提示](https://img.hellowood.dev/picture/nintendo-switch-yuzu-install.png)

## 配置密钥

安装完成后进入，会发现提示密钥缺失；需要使用 Switch 设备的密钥，这些key 是用来解密 XCI 或者 NCA 格式的游戏文件的；

![Yuzu 模拟器提示密钥缺失的界面截图](https://img.hellowood.dev/picture/nintendo-switch-yuzu-miss-keys.png)
...
![在 Yuzu 模拟器中添加 Nintendo Switch 游戏](https://img.hellowood.dev/picture/nintendo-switch-yuzu-add-game.png)

## 测试

使用《塞尔达传说-荒野之息》测试；

![Yuzu模拟器运行塞尔达传说荒野之息资源占用截图](https://img.hellowood.dev/picture/nintendo-switch-yuzu-game-zelda-test2.png)
...
![Yuzu模拟器在Intel i5核显配置下的资源占用对比](https://img.hellowood.dev/picture/nintendo-switch-yuzu-resource-usage.png)
...
![Yuzu 模拟器在 i9 处理器和 3070Ti 显卡上的资源占用数据](https://img.hellowood.dev/picture/nintendo-switch-yuzu-resource-usage-2.png)

...
![Thrift 中 TTransport 类的 Java 源码结构](https://img.hellowood.dev/picture/thrift-java-source-class-transport.png)
...
![Java 源码中 TServerTransport 类的定义与实现](https://img.hellowood.dev/picture/thrift-java-source-class-server-transport.png)

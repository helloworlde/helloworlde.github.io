...
![小米 AX6S 路由器升级完成显示测试版水印](https://img.hellowood.dev/picture/homelab-miwifi-ax6s-openwrt-upgrade.png)

![小米 AX6S 路由器刷入测试版固件升级界面](https://img.hellowood.dev/picture/homelab-miwifi-ax6s-openwrt-upgrade-ongoing.png)

升级完成后路由器会重启，页面有水印提示 `Only For Test`；
![小米AX6S路由器刷入OpenWrt升级完成界面](https://img.hellowood.dev/picture/homelab-miwifi-ax6s-openwrt-upgrade-complted.png)
...
![成功通过 Telnet 登录小米 AX6S 路由器后台](https://img.hellowood.dev/picture/homelab-miwifi-ax6s-openwrt-telnet-success.png)
...
![Redmi AX6S 刷入 OpenWrt 固件执行安装界面](https://img.hellowood.dev/picture/homelab-miwifi-ax6s-openwrt-execute-install.png)
...
![小米 Redmi AX6S 路由器刷入 OpenWrt 后的使用场景](https://img.hellowood.dev/picture/homelab-miwifi-redmi-ax6s-usage.png)

...
![OpenWrt Netdata 实时监控仪表盘展示 CPU 内存网络数据](https://img.hellowood.dev/picture/homelab-openwrt-metrics-netdata.png)
...
![Grafana 中展示 OpenWrt 路由器的监控仪表盘](https://img.hellowood.dev/picture/homelab-openwrt-metrics-grafana.png)

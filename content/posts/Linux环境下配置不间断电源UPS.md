...
![Grafana 监控面板显示 UPS 负载电压温度状态](https://img.hellowood.dev/picture/homelab-ups-grafana-dashboard-3.png)

![Grafana 监控面板展示 UPS 实时状态数据](https://img.hellowood.dev/picture/homelab-ups-grafana-dashboard-2.png)

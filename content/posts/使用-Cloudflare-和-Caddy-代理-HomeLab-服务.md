...
关于 Cloudflare Tunnel 的安装使用可以参考 [使用 Cloudflare Tunnel 作为反向代理访问内网服务](https://blog.hellowood.dev/posts/cloudflare-tunnel-reverse-proxy-access-internal-services/)

关于 Caddy 的安装使用参考 [使用 Caddy 作为反向代理访问内网服务](https://blog.hellowood.dev/posts/caddy-proxy-homelab-services/)
...
![配置 Cloudflare Tunnel 将 whoami 主机名转发到 Caddy](https://img.hellowood.dev/picture/homelab-tunnel-to-caddy-cloudflare-edit-tunnel-router.png)

...
![Hailo 8 系列 TPU 加速器软件功能架构图](https://hailo.ai/wp-content/uploads/2023/09/HailoRT-Diagram.png)
...
![Hailo 开发者软件下载页面选择 PCIe 驱动](https://img.hellowood.dev/picture/homelab-tpu-hailo-software-download-page.png)
...
![Hailo 开发者专区 Ubuntu 软件下载页面](https://img.hellowood.dev/picture/homelab-tpu-hailo-software-download-page.png)
...
![Hailo 开发者软件下载页面中的 Python 包](https://img.hellowood.dev/picture/homelab-tpu-hailo-software-download-page.png)

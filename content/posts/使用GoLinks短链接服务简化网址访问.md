...
![GoLinks 短链接服务主页界面展示](https://img.hellowood.dev/picture/go-links-homepage.png)
...
![OpenWrt 路由器修改搜索域为 svc.local 配置界面](https://img.hellowood.dev/picture/go-links-search-lan-configuration-in-openwrt-page.png)
...
![GoLinks 搜索域在 OpenWrt 路由器中的配置界面](https://img.hellowood.dev/picture/go-links-search-lan-configuration-by-router.png)

##### 修改设备的搜索域

可以通过网络中的 DNS 配置，手动添加 DNS 搜索域
![GoLinks 服务配置中设置搜索域指向 Google 搜索](https://img.hellowood.dev/picture/go-links-search-lan-configuration.png)

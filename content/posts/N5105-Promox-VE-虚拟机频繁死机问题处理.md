...
![Intel N5105 处理器上 Proxmox VE 虚拟机冻结问题](https://img.hellowood.dev/picture/homelab-pve-vm-freeze-issue-bug-feedback.png)
...
![Proxmox VE 5.19 内核虚拟机死机问题反馈截图](https://img.hellowood.dev/picture/homelab-pve-vm-freeze-issue-519-kenel.png)

这个问题在 2022-12-06 状态变更为 'FIX PACKAGED'；在 2022-12-14，PVE员工宣布支持将内核升级到 6.1

![N5105 Proxmox VE 虚拟机死机问题内核升级修复](https://img.hellowood.dev/picture/homelab-pve-vm-freeze-issue-61-kenel.png)

在 Bug 反馈的最后几条评论中，反馈死机的问题在升级 5.19 或 6.1 的内核后确实减少了，但是依然可能出现

![Proxmox VE 虚拟机死机问题修复评论截图](https://img.hellowood.dev/picture/homelab-pve-vm-freeze-issue-bug-comments2.png)

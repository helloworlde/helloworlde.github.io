...
![在 App Store 搜索 macOS Monterey 安装器](https://img.hellowood.dev/picture/homelab-macos-iso-search-in-app-store.png)
...
![MacOS Monterey 安装程序下载进度界面](https://img.hellowood.dev/picture/homelab-macos-iso-downloading.png)
